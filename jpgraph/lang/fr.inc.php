...
** Setup errors
*/
11 => array('Pas de chemin spécifié pour CACHE_DIR. Renseigner manuellement CACHE_DIR dans jpg-config.inc',0),
12 => array('Pas de chemin spécifié pour TTF_DIR et le chemin ne peut pas être déterminé automatiquement. Renseigner manuellement TTF_DIR dans jpg-config.inc.',0),
13 => array('La version de PHP (%s) n\'est pas compatible avec la librairie. La librairie requiert au moins PHP version %s',2),
/*
**  jpgraph_bar
*/

2001 => array('Le nombre de couleurs est différent de celui des patterns dans BarPlot::SetPattern()',0),
2002 => array('Pattern inconnue à l\'appel dans BarPlot::SetPattern()',0),
2003 => array('Le nombre de points X et Y points ne sont pas egaux. Nombre de points X : %d Nombre de points Y : %d',2),
2004 => array('Toutes les valeurs d\'un barplot doivent être numérique. Vous avez renseigné la valeur nr [%d] == %s',2),
2005 => array('Le tableau des shadow colors est vide dans le bar plot.',0),
2006 => array('Position inconnue pour les valeurs de barre : %s',1),
2007 => array('Création d\'un GroupBarPlot impossible avec un tableau de point vide.',0),
